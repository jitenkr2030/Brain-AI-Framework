/**
 * Jest setup file
 * Brain AI LMS - Frontend Test Configuration
 */
...
jest.mock('framer-motion', () => ({
  motion: {
    div: function Div(props: any) {
      return <div {...props} />
    },
    section: function Section(props: any) {
  ...
  useScroll: jest.fn(() => ({ scrollYProgress: { current: 0 } })),
  useTransform: jest.fn((value, inputRange, outputRange) => value),
  useSpring: jest.fn(() => ({ current: 0 })),
  useMotionValue: jest.fn(() => ({ current: 0 }))
}))
...
jest.mock('@heroicons/react/24/outline', () => ({
  ...
  PlayCircleIcon: ({ className }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
